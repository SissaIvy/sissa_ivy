# Endpoint Telemetry & Orchestration Architecture
...
---
This document complements `README.md` and the schema under `schema/`. Update when architectural pivot or phase completion changes assumptions.
